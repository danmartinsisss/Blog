...
def post_list(request, tag_slug=None):
    ...
    try:
        ...
        # If page_number is not an integer deliver the first pagre.
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message,
                      'ti@cartoriomagalhaes.com.br', [cd['to']])
            sent = True
    else:
        form = EmailPostForm()
...
def post_search(request):
    ...
    if 'query' in request.GET:
        ...
        if form.is_valid():
            ...
            # Consulta com remocao de palavras em espanhol
